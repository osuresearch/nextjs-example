...
import { Arrow, Box, Card, Divider, Group, Heading, Icon, Image, LinkButton, OhioStateFooter, OhioStateNavbar, PrimaryButton, Space, Stack, Text } from '@osuresearch/ui'
    ...
    <Stack maw={1090} gap="xl" mx="auto" my="xl">
      ...
      <Group gap="xl" grow>
        <Card
          ...
          href="https://example.com"
          image="https://www.osu.edu/_nuxt/images/Mobility_RI.jpg"
        >
        ...
        <Card
          ...
          href="https://example.com"
          image="https://www.osu.edu/_nuxt/images/Space_RI.jpg"
        >
        ...
        <Card
          ...
          href="https://example.com"
          image="https://www.osu.edu/impact/_nuxt/images/gettyimages-665629334-2.jpg"
        >
